  ...
  return (
    <header className="border-b border-blue-800 bg-casa-navy p-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex items-center gap-2 ml-8">
            <Input
              type="search"
              placeholder="Search..."
              className="w-64 bg-blue-900/50 border-blue-700 text-gray-100 placeholder:text-gray-400"
            />
        ...
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" className="text-gray-100 hover:text-white">
